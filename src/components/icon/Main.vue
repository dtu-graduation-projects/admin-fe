<template>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-10">
        <div class="pt-2 pb-10 sm:py-2 flex items-center dark:border-darkmode-400">
            <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                <Dropdown class="ml-3">
                    <DropdownToggle tag="a" href="javascript:;" class="w-4 h-4 sm:w-5 sm:h-5 block text-slate-500">
                        ...
                        <DropdownContent tag="div">
                            <TabGroup class="chat-dropdown__box flex flex-col" :selectedIndex="1">
                                ...
                                <TabList class="chat-dropdown__box__tabs nav-pills px-1 mt-5">
                                    <Tab class="border-0 w-full px-0 py-2 hover:bg-slate-100 dark:hover:bg-darkmode-400" tag="button">
            ...
            <a
                href="javascript:;"
                class="ml-2 w-8 h-8 sm:w-10 sm:h-10 block bg-primary text-white rounded-full flex-none flex items-center justify-center mr-5"
                @click="postComment()"
            >
